...
function level22:OnCreate()
	CanLeaveLevel2_2 = false
  EntitiesToKill = 0
end

function level22:OnStart()
  ...
  local doorID = SpawnEntity("Level22Floor3Door", 1920 / 3, 1080 - 60, 0)
	FlipDown(Ecs:GetEntity(doorID))

end

function level22:OnUpdate(deltaTime)
	if EntitiesToKill <= 0 then
		CanLeaveLevel2_2 = true
